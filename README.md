# 🛒 B2C E-Commerce RAG System — Trợ Lý Bán Hàng AI 
...
> Xử lý: Thay vì báo lỗi sập hệ thống, AI tự động thay thế bằng các câu trả lời xin lỗi chuẩn nghiệp vụ chăm sóc khách hàng.
...
- **Tầng lưu trữ (SQL Server):** Mọi tin nhắn được ghi vào bảng `ChatHistory` qua **FastAPI Background Task** (chạy ngầm, không block response).
...
<p align="center">
  <img src="data/asset//architecture.png" alt="System Architecture" width="100%" />
</p>
